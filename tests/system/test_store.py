    ...
    def test_create_store(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({"name": "Test Store Name", "items": []},
    ...
    def test_store_found_with_items(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertEqual(response.status_code, 200)
                self.assertDictEqual({"name": "Test Store Name", "items": [{"name": "Test Item Name", "price": 8.99}]},
                                     json.loads(response.data))
    ...
    def test_store_list(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({"stores": [{"name": "Test Store Name", "items": []}]},
                                     json.loads(response.data))
    ...
    def test_store_list_with_items(self):
        with self.app() as client:
            with self.app_context():
                ...
                self.assertDictEqual({"stores": [{"name": "Test Store Name", "items": [{"name": "Test Item Name", "price": 8.99}]}]},
                                     json.loads(response.data))
